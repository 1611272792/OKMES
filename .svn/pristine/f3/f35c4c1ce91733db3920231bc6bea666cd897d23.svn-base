...
window['_mstConfig'] = {
    appId: 'YysqFLcQiDQCqoQOZoCM0XbJ4nInnEnpXjAT73JK77cVEB1_6-87PPRx5SkpR66feWEU8BvxwRB_UF0ABJQelqMBV5aFnal2I8RaQsPMdUO6Mwul-TuNlagK-htbza7aD',
    ...
    imagePath: 'http\x3a\x2f\x2fwww.microsofttranslator.com\x2fstatic\x2f25682789\x2fimg\x2f',
    debug: false,
    locale: 'zh-chs',
    country: '',
    category: '',
...
window._mstConfig['SignIn'] = '<a href="https://login.live.com/login.srf?wa=wsignin1.0&amp;rpsnv=13&amp;ct=1542764303&amp;rver=6.7.6636.0&amp;wp=LBI&amp;wreply=http:%2F%2Fwww.microsofttranslator.com%2Fajax%2Fv2%2Fauth.aspx%3Fpru%3Dhttps%253a%252f%252fblog.csdn.net%252fweixin_40687883%252farticle%252fdetails%252f81451385%253ftdsourcetag%253ds_pctim_aiomsg&amp;lc=2052&amp;id=268160">登录</a>';
...
function () {
    ...
    var Rb = c.serviceClient.LoadScript = new
	function () {
	    function b(f, k) {
	        var c = this,
			b = f.toString().match(/^([^:]*:\/\/[^\/]*)(\/[^\?\#]*)([\?][^#]*)*/);
    ...
    function mc(Fb, nb, qb, ob, db, Gc, Cc, P, J, Lc) {
        ...
        function Kb(e) {
            var b = "_mssrc";
            if (!S) if (l.getElementsByTagName) S = l.getElementsByTagName(y);
            else if (l.documentElement.getElementsByTagName) S = l.documentElement.getElementsByTagName(y);
            else if (l.ownerDocument.documentElement.getElementsByTagName) S = l.ownerDocument.documentElement.getElementsByTagName(y);
            var a;
        ...
        function jb(a) {
            if (a.nodeType == 3) return i;
            else if (a.nodeType != 1 || a._mstChunk || h.getStyleValue(a, "display").toLowerCase() != "inline" || h.getStyleValue(a, mb).toLowerCase() != "static" || rb[a.nodeName.toLowerCase()]) return s;
        ...
        function T(a, i, e) {
            ...
            for (var b = 0; b < a.childNodes.length; ++b) switch (a.childNodes[b].nodeType) {
                case 1:
                    ...
                    if (g == m.Skip && a.childNodes[b].previousSibling && a.childNodes[b].previousSibling.nodeType == 1) a.childNodes[b].previousSibling._mstSkipNext = f;
                    else if (g == m.Skip && a.childNodes[b].nextSibling && a.childNodes[b].nextSibling.nodeType == 1) a.childNodes[b].nextSibling._mstSkipPrev = f;
                    else {
                        d.push("<");
                        d.push(j);
                        d.push(">");
        ...
        function Ab(a) {
            ...
            else return a.replace(/<\w+>/g, v).replace(/<\/\w+>/g, v).replace(/&gt;/gi, ">").replace(/&lt;/gi, "<").replace(/&amp;/gi, r)
        }
        function Hc(a) {
	...
	t; (function (d) {
	    ...
	    function jb(k, d, b) {
			...
			i = ob;
	        d === void 0 && (d = "true"),
			(b === void 0 && (b = a), (y = Util.GetElement(pb), (f = Util.GetElement(cb), (F = Util.GetElement(qb), (N = Util.GetElement(rb), (R = Util.GetElement(sb), (G = Util.GetElement(tb), (J = b == a, h = b))))))));
	        var e = document.createElement("link");
	        e.setAttribute(O, window._mstConfig.floaterStylePath),
			e.setAttribute("rel", ub);
	        var l = document.getElementsByTagName(D)[0];
	        l.insertBefore(e, l.firstChild),
			(f.onmousedown = gb, (y.setAttribute(i, j), (y.setAttribute(vb, wb), (F.setAttribute(i, j), (L = k, Microsoft.Translator.Widget.GetLanguagesForTranslate(k, T, U))))));
	        ...
	        d.toLowerCase() == M && (W = !1),
			(Z = !0, (window._bwmid ? (window._bwmid += yb) : (window._bwmid = zb), (Rb(Ab, (document.location.protocol == "https:" ? Bb : Cb) + Db), !V && W && (c.serviceClient.Community.forceLoad(), V = !0))))
	    }
	    function eb() {
	        f.style.display = k
	    }
	        ...
	        var e = setInterval(function () {
	            if (window.LanguageMenu) {
	                ...
	                try {
	                    ...
	                    i = Util.GetElement(db),
						h == a ? (i.parentNode.style.display = q) : (i.parentNode.style.display = k, J ? (i.innerHTML = window._mstConfig.autoDetected.replace(v, o[h])) : (i.innerHTML = o[h]))
	                } catch (b) {
	                    console.warn(b)
	                }
	                clearInterval(e)
	    ...
	    function t() {
	        y.style.display = q,
			(N.style.display = q, (F.style.display = q, (R.style.display = q, (A = !1, clearTimeout(p)))))
	    }
	    function w(a, b) {
	        f.style.top = b + n,
			f.style.left = a + n
	    ...
	    function mb(e) {
	        ...
	        if (d && window.LanguageMenu && window.LanguageMenu.getValue) {
	            h = d,
				(i.parentNode.style.display = k, J ? (i.innerHTML = window._mstConfig.autoDetected.replace(v, o[h])) : (i.innerHTML = o[h]));
	            var l = o[d],
	            ...
	            c = c.replace(v, encodeURIComponent(g + n + K + window.LanguageMenu.getValue())),
				(c = c.replace(P, encodeURIComponent(g)), (Util.GetElement(Hb).setAttribute(O, Ib + b + "&body=" + c), (Util.GetElement(Jb).setAttribute("title", Util.GetElement(Kb).getAttribute(m).replace(v, f)), window.Util.SetCookie("mstto", window.LanguageMenu.getValue(), !1))))
	        }
	    }
	    function Ob(a) {
	        console.log(a)
	    ...
	    function Vb() {
	        ...
	        location.search.length == 0 ? Util.GetElement(c).setAttribute(m, b + Mb + g) : location.search.indexOf("__mstto") != e ? b.match(/__mstto=(.+)([&]+)/i) ? Util.GetElement(c).setAttribute(m, b.replace(/__mstto=(.+)([&&]+)/i, K + g + r)) : b.match(/__mstto=(.+)/i) && Util.GetElement(c).setAttribute(m, b.replace(/__mstto=(.+)/i, K + g)) : Util.GetElement(c).setAttribute(m, b + Nb + g),
			N.style.display = k
	    }
	    function Wb() {
	        t(),
	    ...
	    function gb(a) {
	        return a = a || event,
			(H = a.clientX, (I = a.clientY, (document.onmousemove = hb, (document.onmouseup = ib, (document.body.focus(), (document.onselectstart = function () {
			    return !1
			},
	    ...
	    function hb(a) {
			...
			c = a.clientX - H,
			d = a.clientY - I;
	        return w(parseInt(b.left) + c, parseInt(b.top) + d),
			(H = a.clientX, (I = a.clientY, !1))
	    }
	    function ib(a) {
	        return a = a || event,
			(document.onmousemove = s, (document.onselectstart = s, (f.ondragstart = s, (Util.removeClass(f, fb), !1))))
	    }
	    var o = {},
		L, g, h = s,
		p = s,
		...
		J;
	    d.Initialize = jb,
		(d.Show = C, (d.TranslationComplete = lb, (d.TranslationProgress = mb, (d.TranslationError = Ob, (d.OnClose = Pb, (d.OnShareBackClick = Qb, (d.OnEmbedBackClick = Sb, (d.OnMouseOverFloater = Tb, (d.OnMouseOutFloater = Ub, (d.ShowSharePanel = Vb, d.ShowEmbed = Wb))))))))))
	})(t || (t = {})),
	(k.FloaterInitialize = function (a, b, c) {
	    t.Initialize(a, b, c)
	},
	...
	(k.OnMouseOverFloater = function () {
	    return t.OnMouseOverFloater(),
		!1
	},
	k.OnMouseOutFloater = function () {
	    return t.OnMouseOutFloater(),
		!1
	})))))));
    ...
    var oc = function () {
        ...
        function b() {
            var b = this;
            b.languageNames = [],
			(b.langLocalized = d, (b.appId = window._mstConfig.appId, (b.unTranslateDelegate = d, (b.Links = new pc(window._mstConfig.SignIn ? window._mstConfig.SignIn : a, window._mstConfig.SignOut ? window._mstConfig.SignOut : a, "http://go.microsoft.com/?linkid=9722454"), (b.UserName = window._mstConfig.UserName ? window._mstConfig.UserName : a, b.languageCodes = [])))));
		...
		(b.prototype.TranslateElement = function (p, j, h, m, e, n, o, k, b) {
		    var a = this;
		    h === void 0 && (h = document.documentElement),
			(b === void 0 && (b = !0), (a.validate(p, "from", !1, f), a.validate(j, "to", !0, f)));
		    if (!a.isElement(h) && !a.isNode(h)) throw new Error("Invalid DomElement");
		    a.validate(m, "onProgress", !1, c),
			(a.validate(e, "onError", !1, c), (a.validate(n, i, !1, c), (a.validate(o, "onRestoreOriginal", !1, c), (a.validate(k, "timeOut", !1, g, !0), a.validate(b, "showFloater", !1, "boolean")))));
		    var l = !1;
		    a.lastToLanguage = j,
			(a.domTranslator != d && a.domTranslator.cancel && a.domTranslator.cancel(), b && t.Show(j));
		    var s = function () {
		        q(u),
				l = !0;
		        try {
		    ...
		    a.domTranslator = new mc(a.appId, h, p, j, s, e, k, !1, !1),
			(a.domTranslator.addProgressEvent && a.domTranslator.addProgressEvent(q), o && (a.unTranslateDelegate = o));
		    if (e && k) {
		...
		(b.prototype.GetLanguagesForTranslate = function (b, e, h, j) {
		    var a = this;
		    a.validate(b, "locale", !0, f),
			(a.validate(e, i, !0, c), (a.validate(h, "onError", !1, c), a.validate(j, "timeOut", !1, g, !0)));
		...
		(b.prototype.UpdateAppID = function (a, b) {
		    this.appId = a,
			(window._mstConfig.appId = this.appId, Microsoft.Translator.Widget.UpdateDashboardLink(encodeURIComponent(b)))
		},
	...
	function (K) {
	    ...
	    function sb(c) {
	        ...
	        m.setLock(P);
	        for (var b = 0; b < k.length; ++b) if (b >= l && b < l + 3) k[b].panel.style.display = u;
	    ...
	    function qb(a, f, g) {
			...
			function (d) {
			    for (var c = 0; c < d.length; ++c) if (d[c].Translations.length > 1) if (d[c].Translations[0].Rating > 5) a.transItems[s + c].tgt.style.backgroundColor = "#E6E6E6";
	...
	t; (function (h) {
	    ...
	    function Qb() {
	        ...
	        if (location.search.length == 0) Util.GetElement(c).setAttribute(t, b + Mb + i);
	            ...
	            if (b.match(/__mstto=(.+)([&]+)/i)) Util.GetElement(c).setAttribute(t, b.replace(/__mstto=(.+)([&&]+)/i, eb + i + r));
...
window['_mstConfig'].floaterStylePath = 'http://www.microsofttranslator.com/static/25682789/css/WidgetV3.css?v=25682789';
